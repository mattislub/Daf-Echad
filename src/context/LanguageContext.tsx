...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    'cart.terms.label': 'אני מאשר/ת את התקנון ומדיניות האתר לפני התשלום',
    'cart.terms.cta': 'צפייה בתקנון',
  ...
  en: {
    ...
    'cart.terms.label': 'I confirm the site terms and policies before completing payment',
    'cart.terms.cta': 'View terms',
